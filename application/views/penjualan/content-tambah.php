        ...
        <div class="col-xs-12">
          ...
          <div class="box-body">
            ...
            <table style="width:100%;">
              <thead>
                <tr>
                  <td width="73">Nama Toko</td>
                  <td>: <b>Supermarket</b></td>
                  <td rowspan="2">
                  <div class="form form-horizontal">
                    <div class="form-group">
                      <label for="kode_member" class="col-md-7 control-label">Kode Member</label>
                      <div class="col-md-5">
                        <input type="number" class="form-control" id="input_kode_member" onfocusout="updateKodeMember()" min="0" value="0">
                      </div>
                    </div>
                  </div>
                  </td>
                ...
                <tr>
                  <td>Tanggal</td>
                  <td>: <b><?= formatTanggalLengkap($this->waktu_sekarang) ?></b></td>
                </tr>
              </thead>
            </table>
            <hr>
            ...
            <?= form_open('', ['class' => 'form-keranjang']) ?>
              ...
              <input type="hidden" id="kode_member" name="kode_member" value="">
              ...
              <div class="col-md-8">
                 <div id="tampil-bayar" style="background: #dd4b39; color: #fff; font-size: 80px; text-align: center; height: 130px">Rp. <span class="tampil-total-bayar">0</span></div>
                 <div id="tampil-terbilang" style="background: #3c8dbc; color: #fff; font-weight: bold; padding: 15px"> Rupiah</div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form form-horizontal form-pembelian">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="number" class="form-control" id="diskon" name="diskon" min="0" max="100" onfocusout="dapatDiskon(this.value)">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="uang_diterima" class="col-md-4 control-label">Uang Diterima</label>
                    <div class="col-md-8">
                      <input type="text" class="form-control" id="uang_diterima" name="uang_diterima" min="0" required>
                    </div>
                  </div>
